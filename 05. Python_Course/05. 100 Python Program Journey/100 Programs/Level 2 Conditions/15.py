...
print("Welcome to Smallest of Three Numbers Identifier Program.")
...
if num1 < num2 and num1 < num3 and num2!=num3:
    print(f"Your Smallest Number is {num1}")

elif num2 < num1 and num2 < num3 and num1!=num3:
    print(f"Your Smallest Number is {num2}")

elif num3 < num1 and num3 < num2 and num1!=num2:
    print(f"Your Smallest Number is {num3}")
